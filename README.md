...
> **R:**Porque la linea de #include es reemplazada por todo el contenido que incluye esa biblioteca.
...
> **R:**Porque los comentarios son eliminados por el preprocesador antes de que el compilador procese el código.
...
> **R:**$ gcc -E programa.c | grep "Iniciando"
...
> **R:**Estas líneas indican el archivo y la línea original de donde proviene cada bloque de código incluido. La declaración de printf proviene de stdio.h.
...
> **R:**$ grep "area_circulo" programa.s
...
> **R:**Estas instrucciones preparan la pila, guardan parámetros y reservan espacio para ejecutar la función.
...
> **R:**Aparece como indefinida porque solo se utiliza allí. En matematica.o aparece definida porque su implementación está en ese archivo.
...
> **R:**$ nm programa.exe | grep "area_circulo"
...
> **R:**Porque pertenecen a bibliotecas dinámicas del sistema. Se resuelven en tiempo de ejecución cuando el sistema carga el programa.
...
> **R:**Una macro función se reemplaza por texto durante el preprocesamiento y no tiene verificación de tipos. Una función real se compila normalmente, tiene parámetros definidos y verifica tipos. La macro desaparece en el preprocesamiento, mientras que la función permanece hasta el enlazado.
...
> **R:**Un símbolo T representa código ejecutable almacenado en la sección .text, normalmente funciones. Un símbolo D representa variables globales inicializadas ubicadas en la sección .data.
